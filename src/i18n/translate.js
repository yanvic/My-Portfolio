    ...
    articles_card: [
      {
        ...
        desc: "How to implement a microservices architecture that truly scales and works in production.",
        readTime: "8 min",
        views: "2.4k",
      },
      {
        ...
        desc: "Best practices for conducting code reviews that enhance code quality and team collaboration.",
        readTime: "6 min",
        views: "1.8k",
      },
      {
        ...
        desc: "A comprehensive guide to setting up continuous integration and continuous deployment pipelines.",
        readTime: "10 min",
        views: "3.1k",
      },
    ],
  ...
  pt: {
    ...
    articles_card: [
      ...
      },
      {
        date: "10 FEV 24",
        tag: "Desenvolvimento",
        title: "Revisões de Código Eficazes",
        desc: "Melhores práticas para conduzir revisões de código que aprimoram a qualidade do código e a colaboração da equipe.",
        readTime: "6 min",
        views: "1.8k",
      },
      {
        date: "05 MAR 24",
        tag: "DevOps",
        title: "Entendendo Pipelines CI/CD",
        desc: "Um guia completo para configurar pipelines de integração contínua e entrega contínua.",
        readTime: "10 min",
        views: "3.1k",
      }
    ],
